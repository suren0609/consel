  ...
  return (
    <div className={styles.HomePage}>
      ...
      <div className={styles.homeImage}>
        <div id={styles.one} className={styles.circle}>
          1
        ...
        <div id={styles.two} className={styles.circle}>
          2
          <div className={styles.imagePopup}>
            <h4>Ապրանքի անվանում</h4>
            <p>
        ...
        <div id={styles.three} className={styles.circle}>
          3
        </div>
        <div id={styles.four} className={styles.circle}>
          4
          <div className={styles.imagePopup}>
            <h4>Ապրանքի անվանում</h4>
            <p>
